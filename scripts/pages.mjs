...
export function renderProject(p,lang){
  ...
  const gallery=m.gallery?.length?`<section class="detail-section" id="gallery"><div class="detail-heading"><span>↗</span><h2>${esc(c.galleryTitle||t.gallery)}</h2></div>${carousel(m.gallery,lang,base,c.galleryTitle||t.gallery)}</section>`:'';
